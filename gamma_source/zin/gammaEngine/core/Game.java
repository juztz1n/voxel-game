...
public abstract class Game
{
	...
	public Game(String title, int width, int height, DisplayState state, double ups, boolean logMetrics, boolean verbose)
	{
		this.title = title;
		this.width = width;
		this.height = height;
		...
		getEngine().setLogMetrics(true);
		getEngine().setVerbose(true);
	...
	public GameObject addSimpleObject(GameComponent component)
	{
		return getRootObject().addChild(new GameObject().addComponent(component));
	}
